...
public class GenerateMybatisPlus {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("liansr@nala.com.cn");
        gc.setOpen(false);
//        gc.setBaseResultMap(true);
        ...
        dsc.setUrl("jdbc:mysql://192.168.142.208:3306/b2b_1?userUnicode=true&characterEncoding=utf8&pinGlobalTxToPhysicalConnection=true");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.nala.sharding")
                .setMapper("mapper")
                .setService("service")
